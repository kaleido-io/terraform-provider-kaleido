		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(pms_policy_attachment_resource, "attachment_point", "wal:1234567890"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr(pms_policy_attachment_resource, "attachment_point", "was:1234567890"),
				),
			},
		},
	})
