...
- `default_key_attributes` (Map of String) Optional map of default key attributes applied to keys created in this wallet. Sent to the API as `defaultKeyAttributes`.
